...
# For first time entry, run the below function once separately which will initialize the appropriate encodings in the txt files
# Then comment it out and normal operation can be resumed in the QT app
